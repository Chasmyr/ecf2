...
class getSecurity_AccessMapService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/formation/'), [0 => 'ROLE_USER'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/user'), [0 => 'ROLE_USER'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/create/formation'), [0 => 'ROLE_FORMATEUR'], NULL);
