 ...
 */
class getAnnexeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AnnexeRepository' shared autowired service.
     *
     * @return \App\Repository\AnnexeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AnnexeRepository.php';

        return $container->privates['App\\Repository\\AnnexeRepository'] = new \App\Repository\AnnexeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
