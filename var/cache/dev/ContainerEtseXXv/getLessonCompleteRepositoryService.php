 ...
 */
class getLessonCompleteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LessonCompleteRepository' shared autowired service.
     *
     * @return \App\Repository\LessonCompleteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LessonCompleteRepository.php';

        return $container->privates['App\\Repository\\LessonCompleteRepository'] = new \App\Repository\LessonCompleteRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
