...
/* base.html.twig */
class __TwigTemplate_b1f9111e21b2ceb21f554c0d420b137d85ae85d7ecfd32bdd44de7c4bd5e9c27 extends Template
{
    private $source;
    private $macros = [];
...
<html>
    <head>
        ...
        ";
        // line 9
        echo "        <link rel=\"stylesheet\" href=\"/css/nav/nav.css\">
        ";
        // line 10
    ...
    <body>
        ...
        echo "\"><img src=\"/img/logo.png\" class=\"navbar-logo\"></a>
            <p class=\"navbar-item long-item\"><a href=\"";
        // line 18
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_formation");
        echo "\">Liste des Formations</a></p>
            <p class=\"navbar-item short-item\"><a href=\"";
        // line 19
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_formation");
        echo "\">Les Formations</a></p>
            <p class=\"navbar-item shortier-item\"><a href=\"";
        // line 20
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_formation");
        echo "\">Formations</a></p>
            ";
        ...
        if ( !twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 21, $this->source); })()), "user", [], "any", false, false, false, 21)) {
            // line 22
            echo "                <p class=\"navbar-item\"><a href=\"";
            echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("security_login");
            echo "\">Connexion</a></p>
                ";
        } elseif ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source,         // line 23
(isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 23, $this->source); })()), "user", [], "any", false, false, false, 23), "roles", [], "any", false, false, false, 23) == [0 => "ROLE_ADMIN"])) {
            // line 24
            echo "                    <p class=\"navbar-item\"><a href=\"";
            echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("user_admin");
            echo "\">Gestion admin</a></p>
                ";
        } elseif ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source,         // line 25
(isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 25, $this->source); })()), "user", [], "any", false, false, false, 25), "roles", [], "any", false, false, false, 25) == [0 => "ROLE_FORMATEUR"])) {
            // line 26
            echo "                    <p class=\"navbar-item\"><a href=\"";
            echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("list_formation");
            echo "\">Mes formations</a></p>
                ";
        } else {
            // line 28
            echo "                    <p class=\"navbar-item\"><a href=\"";
            echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("user_acc");
            echo "\">Mon compte</a></p>
            ";
        }
        // line 30
...
";
    ...
    {
        return array (  204 => 33,  194 => 32,  176 => 31,  163 => 11,  153 => 10,  134 => 6,  122 => 35,  119 => 32,  117 => 31,  114 => 30,  108 => 28,  102 => 26,  100 => 25,  95 => 24,  93 => 23,  88 => 22,  86 => 21,  82 => 20,  78 => 19,  74 => 18,  70 => 17,  64 => 13,  62 => 10,  59 => 9,  54 => 6,  47 => 1,);
    }
