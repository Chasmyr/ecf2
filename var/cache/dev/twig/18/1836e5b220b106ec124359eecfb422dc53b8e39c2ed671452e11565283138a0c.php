...
class __TwigTemplate_1878d744a4c6f39e43566572d4ccc0a2b9bd9502cdce9c3ebc49828f43dd8c1d extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"options-logout\">
        ...
        echo "\" class=\"logout\">Se deconnecter</a>
            ";
        // line 39
        if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 39, $this->source); })()), "user", [], "any", false, false, false, 39), "state", [], "any", false, false, false, 39) == true)) {
            // line 40
            echo "                <a href=\"";
            echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("create_formation");
            echo "\" class=\"create-formation\">Créer une formation</a>
            ";
        }
        // line 42
        echo "    </div>
...
";
    ...
    {
        return array (  168 => 42,  162 => 40,  160 => 39,  156 => 38,  149 => 33,  139 => 29,  134 => 27,  131 => 26,  127 => 25,  110 => 10,  100 => 9,  89 => 6,  79 => 5,  60 => 3,  37 => 1,);
    }
...
{% block body %}
    ...
    <div class=\"options-logout\">
            ...
            {% if app.user.state == true %}
                <a href=\"{{ path('create_formation') }}\" class=\"create-formation\">Créer une formation</a>
            {% endif %}
    </div>

{% endblock %}", "formation/formationList.html.twig", "E:\\ecf2\\templates\\formation\\formationList.html.twig");
    }
}
